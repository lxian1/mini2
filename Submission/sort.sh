...
sort ads.txt -n | uniq | perl break.pl | db_load -T -t hash ad.idx
sort terms.txt | uniq | perl break.pl | db_load -T -t btree te.idx
sort pdates.txt | uniq | perl break.pl | db_load -T -t btree da.idx
sort prices.txt -n | uniq | perl break.pl | db_load -T -t btree pr.idx